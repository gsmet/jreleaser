 ...
 */
package org.jreleaser.sdk.nexus.api;
...
public interface NexusAPI {
    ...
    @RequestLine("PUT staging/deployByRepositoryId/{repositoryId}/{path}")
    void upload(@Param("repositoryId") String repositoryId, @Param("path") String path, byte[] data);
